...
(use-package dashboard
  ...
  (dashboard-startup-banner '(1 2 3 4))
  ...
  (dashboard-footer-messages '("Placeholder 0"
                               "Placeholder 1"))
  :config
...
(global-set-key (kbd "C-c p") 'describe-key)
(global-set-key (kbd "C-c q") 'prog-fill-reindent-defun)
...
(defun my-lilypond-gen ()
  "Run 'lilypond' over buffer's file in directory"
  (interactive)
  (shell-command (format "lilypond %s" (buffer-file-name))))

(define-key LilyPond-mode-map
            (kbd "C-c c") 'my-lilypond-gen)
#+END_SRC

TODO: keybinds to compile in directory, automatically show generated
PDF with auto-revert-mode, play generated MIDI via Audacious

** Lisp Data Mode
Temporary stand-in for Sail mode
#+BEGIN_SRC emacs-lisp
(add-to-list 'auto-mode-alist '("\\.sl\\'" . lisp-data-mode))
#+END_SRC
...
(use-package rust-mode
  ...
  :hook ((rust-mode . eglot-ensure)))
         ;; (rust-mode . (lambda () (font-lock-add-keywords nil
         ;;                            '(("\\_<\\(unsafe\\)\\_>" 1
         ;;                               'bold prepend)))))))
(use-package cargo
...
* LSP Client
Use the Language Server Protocol, via Eglot, to get additional insight
into code
...
(use-package eglot
  ...
  :bind (:map eglot-mode-map
              ...
              ("C-c s c" . eglot-show-call-hierarchy)
              ("C-c s t" . eglot-show-type-hierarchy)))

;; (use-package eglot-booster
;;   :vc "https://github.com/jdtsmith/eglot-booster"
;;   :after eglot
;;   :config
...
;; (add-hook 'eglot-managed-mode-hook #'hl-todo-mode t)
